% iaqf 2026: solution max 10 pages, single-sided, times new roman 12pt.
% blind judging: no reference to school, students, or team name.
% code submitted as separate addendum.
\documentclass[12pt,oneside,a4paper]{article}
\usepackage[utf8]{inputenc}
\usepackage[T1]{fontenc}
\usepackage{times} % times new roman for text; math uses default to avoid missing rsfs in tinytex
\renewcommand{\ttdefault}{cmtt} % computer modern typewriter for \texttt (avoids missing pcr in tinytex)
\usepackage{geometry}
\usepackage{amsmath}
\usepackage{graphicx}
\usepackage{booktabs}
...
\author{} % blind: no school, student, or team name
\date{}

% hyperref loaded last so cross-refs resolve (run pdflatex twice)
...
\input{tables/stablecoin_summary}
\end{table}
